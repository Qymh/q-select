(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('vue'), require('@qymh/vue-q-select/src/index')) :
  typeof define === 'function' && define.amd ? define(['vue', '@qymh/vue-q-select/src/index'], factory) :
  (global = global || self, factory(global.Vue, global.QSelect));
}(this, (function (Vue, QSelect) { 'use strict';

  Vue = Vue && Vue.hasOwnProperty('default') ? Vue['default'] : Vue;
  QSelect = QSelect && QSelect.hasOwnProperty('default') ? QSelect['default'] : QSelect;
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-e973795c_0", { source: "\n.cell[data-v-e973795c] {\n  padding: 10px 10px;\n  display: flex;\n  width: 100%;\n  box-sizing: border-box;\n  overflow: hidden;\n  font-size: 14px;\n  position: relative;\n}\n.cell[data-v-e973795c]::after {\n  content: ' ';\n  position: absolute;\n  left: 0;\n  bottom: 0;\n  width: 100%;\n  height: 1px;\n  transform-origin: bottom right;\n  transform: scaleY(0.5);\n  border-bottom: 1px solid #ebebeb;\n}\n.cell--force[data-v-e973795c] {\n  background-color: deepskyblue;\n  color: #fff;\n}\n.title[data-v-e973795c] {\n  flex-grow: 1;\n  flex-shrink: 1;\n  flex-wrap: wrap;\n}\n.details[data-v-e973795c] {\n  flex-grow: 0;\n  flex-shrink: 0;\n  text-align: right;\n  margin-left: 10px;\n}\n", map: {"version":3,"sources":["/Users/qymh/Documents/SelectQ/demo/vue/components/cell.vue"],"names":[],"mappings":";AAqCA;EACA,kBAAA;EACA,aAAA;EACA,WAAA;EACA,sBAAA;EACA,gBAAA;EACA,eAAA;EACA,kBAAA;AACA;AACA;EACA,YAAA;EACA,kBAAA;EACA,OAAA;EACA,SAAA;EACA,WAAA;EACA,WAAA;EACA,8BAAA;EACA,sBAAA;EACA,gCAAA;AACA;AACA;EACA,6BAAA;EACA,WAAA;AACA;AACA;EACA,YAAA;EACA,cAAA;EACA,eAAA;AACA;AACA;EACA,YAAA;EACA,cAAA;EACA,iBAAA;EACA,iBAAA;AACA","file":"cell.vue","sourcesContent":["<template>\n  <div :class=\"['cell', force ? 'cell--force' : '']\">\n    <div class=\"title\">\n      {{ title }}\n    </div>\n    <div v-if=\"!force && !hideDetails\" class=\"details\" @click=\"doClick\">\n      点击显示\n    </div>\n  </div>\n</template>\n\n<script>\nexport default {\n  name: 'Cell',\n  props: {\n    title: {\n      type: String,\n      default: ''\n    },\n    hideDetails: {\n      type: Boolean,\n      default: false\n    },\n    force: {\n      type: Boolean,\n      default: false\n    }\n  },\n  methods: {\n    doClick() {\n      this.$emit('click');\n    }\n  }\n};\n</script>\n\n<style scoped>\n.cell {\n  padding: 10px 10px;\n  display: flex;\n  width: 100%;\n  box-sizing: border-box;\n  overflow: hidden;\n  font-size: 14px;\n  position: relative;\n}\n.cell::after {\n  content: ' ';\n  position: absolute;\n  left: 0;\n  bottom: 0;\n  width: 100%;\n  height: 1px;\n  transform-origin: bottom right;\n  transform: scaleY(0.5);\n  border-bottom: 1px solid #ebebeb;\n}\n.cell--force {\n  background-color: deepskyblue;\n  color: #fff;\n}\n.title {\n  flex-grow: 1;\n  flex-shrink: 1;\n  flex-wrap: wrap;\n}\n.details {\n  flex-grow: 0;\n  flex-shrink: 0;\n  text-align: right;\n  margin-left: 10px;\n}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__ = "data-v-e973795c";
    /* module identifier */
    ...
    const __vue_component__ = dist_1(
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_component__$1 = dist_1(
  ...
  __vue_render__$2._withStripped = true;
    ...
    const __vue_component__$2 = dist_1(
