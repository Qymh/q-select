...
var Component = VueCompositionApi.createComponent({
    setup: function (props, context) {
        ...
        VueCompositionApi.watch(function () { return props.defaultKey; }, function (val) {
            if (val && val.length) {
                if (pending.value) {
        ...
        VueCompositionApi.watch(function () { return props.defaultValue; }, function (val) {
            if (val && val.length) {
                if (pending.value) {
                    exports.VueSlash.nextTick(function () {
        ...
        VueCompositionApi.watch(function () { return props.visible; }, function (val) {
            if (val) {
                if (pending.value) {
                    exports.VueSlash.nextTick(function () {
                        show();
        ...
        VueCompositionApi.watch(function () { return props.loading; }, function (val) {
            if (val) {
                if (pending.value) ;
                else {
                    setLoading();
        ...
        VueCompositionApi.watch(function () { return props.data; }, function (val) {
            setData(val);
        ...
        VueCompositionApi.watch(function () { return props.index; }, function (val) {
            setIndex(val);
        }, {
            lazy: true
        });
        VueCompositionApi.watch(function () { return props.title; }, function (val) {
            setTitle(val);
        }, {
            lazy: true
        });
